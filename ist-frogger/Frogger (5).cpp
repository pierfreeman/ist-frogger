...
public:
	...
	virtual void Draw() 
	{
        ...
        GLfloat material_Ka[] = {0.00, 0.06, 1.11, 1.00}; //ambient
        GLfloat material_Kd[] = {0.00, 0.00, 1.0, 1.00}; //diffusion
        GLfloat material_Ks[] = {0.00, 1.33, 0.52, 1.00}; //specular
...
void DrawBackGround()
{
	...
	//bottom sidewalk
    GLfloat material1_Ka[] = {0.00, 0.00, 0.00, 1.00}; //ambient
    GLfloat material1_Kd[] = {0.5, 0.5, 0.5, 1.00}; //diffusion
    GLfloat material1_Ks[] = {1.0, 1.0, 1.0, 1.00}; //specular
    GLfloat material1_Ke[] = {0.0, 0.0, 0.0, 0.00}; //emission
    GLfloat material1_Se[] = {100}; //shineness
    //Setting the materials
    glColorMaterial(GL_FRONT, GL_AMBIENT_AND_DIFFUSE);
    ...
    //Road
    GLfloat material2_Ka[] = {0.00, 0.00, 0.00, 1.00}; //ambient
    GLfloat material2_Kd[] = {0.5, 0.5, 0.5, 1.00}; //diffusion
    GLfloat material2_Ks[] = {1.0, 1.0, 1.0, 1.00}; //specular
    GLfloat material2_Ke[] = {0.00, 0.00, 0.00, 0.00}; //emission
    GLfloat material2_Se[] = {50}; //shineness
    //Setting the materials
    glColorMaterial(GL_FRONT, GL_AMBIENT_AND_DIFFUSE);
	...
	//top sidewalk
    GLfloat material3_Ka[] = {0.00, 0.00, 0.00, 1.00}; //ambient
    GLfloat material3_Kd[] = {0.5, 0.5, 0.5, 1.00}; //diffusion
    GLfloat material3_Ks[] = {1.0, 1.0, 1.0, 1.00}; //specular
    GLfloat material3_Ke[] = {0.00, 0.00, 0.00, 0.00}; //emission
    GLfloat material3_Se[] = {100}; //shineness
	...
	//River
    GLfloat material4_Ka[] = {0.00, 0.00, 0.00, 1.00}; //ambient
    GLfloat material4_Kd[] = {0.01, 0.01, 0.01, 1.00}; //diffusion
    GLfloat material4_Ks[] = {0.8, 0.8, 0.8, 1.00}; //specular
    GLfloat material4_Ke[] = {0.00, 0.00, 0.00, 0.00}; //emission
	...
	//leafs?
    GLfloat material5_Ka[] = {0.01, 0.01, 0.01, 1.00}; //ambient
    GLfloat material5_Kd[] = {0.01, 0.01, 0.01, 1.00}; //diffusion
    GLfloat material5_Ks[] = {0.8, 0.8, 0.8, 1.00}; //specular
    GLfloat material5_Ke[] = {0.00, 0.00, 0.00, 0.00}; //emission
    GLfloat material5_Se[] = {100}; //shineness
...
void onDisplay(void) {
    ...
    GLfloat light_pos1[] = {0.7, -0.9, 1, 1.00};
    ...
    GLfloat light_posFrog[] = {frog.pos.x, frog.pos.y, frog.pos.z, 1.00};
    
    //Definition of the lightpoints parameters
    GLfloat light_Ka[] = {0.01, 0.01, 0.01, 1.00}; //ambient
    GLfloat light_Kd[] = {0.4, 0.4, 0.4, 1.00}; //diffusion
    ...
    //glLightf (GL_LIGHT0, GL_SPOT_CUTOFF, 20.f);
...
void UpdateLives() {
	lives -= 1;
	if(lives > 0){ std::cout << "You died! You only have " << lives << " lives left...\n"; }
	if(lives == 0) {
		RestartMenu();
	}
}
...
void animateWorld(long dt)
{
	...
	if(!paused) {
		...
		for (int i=0; i<14; i++){
			...
			if( (!frog.isItOnATrunk && fy+ 0.035 >= 0.05 && fy - 0.035 <= 0.55) || (frog.isItOnATrunk && (fx+ 0.035>= 1.0 || fx- 0.035 <= -1.0) ) )
			{
				frog.pos.x = 0;
				frog.pos.y = -0.9;
				frog.pos.z = 0;
